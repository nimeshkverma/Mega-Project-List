...
A list of practical projects that anyone can solve in any programming language. Inspired by [100+ Project List](http://www.dreamincode.net/forums/topic/78802-martyr2s-mega-project-ideas-list/) and [Git Repo](https://github.com/karan/Projects) (See [solutions](https://github.com/thekarangoel/Projects-Solutions)). These projects are divided in multiple categories, and each category has its own folder.

To get started, simply fork [Git Repo](https://github.com/karan/Projects).
